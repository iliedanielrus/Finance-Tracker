...
import com.example.expensewizard.client.postTransaction
            ...
            Row(horizontalArrangement = Arrangement.SpaceAround, verticalAlignment = Alignment.CenterVertically,
                ...
                Button(colors = ButtonDefaults.buttonColors(BG_COLOR_CARDS),
                    onClick = {
                        ...
                        if (!errors) {
                            val transaction = Transaction(0,title.text,type,category,amount.text.toDouble(), Date())
                            val res = postTransaction(transaction, viewModel)
